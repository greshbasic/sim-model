...
SimulationModel::SimulationModel(IController& controller)
  ...
  entityFactory.addFactory(new PirateFactory());
  entityFactory.addFactory(new ShipFactory());
}
...
IEntity* SimulationModel::createEntity(const JsonObject& entity) {
  ...
  if (Pirate* pirate = dynamic_cast<Pirate*>(myNewEntity)) {
    the_pirates.push_back(pirate);
  }
